...
internal static class Converter
{
	public static WorldData Convert(Buildplate buildplate, ExportTarget exportTarget, string biome, bool night, string worldName)
	{
		...
		FillWithEmptyChunks(worldData, buildplate.Offset.Y - 1);
	...
	private static void FillWithEmptyChunks(WorldData worldData, int groundPos)
	{
		...
		foreach (var (path, data) in worldData.Files)
		{
